...
const TripDetailsScreen = ({navigation, route}) => {
  ...
  return (
    <View style={styles.container}>
      <Animatable.View
        style={[styles.backButton, {marginTop: insets.top, marginTop: spacing.m}]}
        animation="fadeIn"
        delay={500}
        duration={400}
        easing="ease-in-out">
      ...
      <Animatable.View
        style={[styles.favoriteButton, {marginTop: insets.top, marginTop: spacing.m}]}
        animation="fadeIn"
        delay={500}
        duration={400}
        easing="ease-in-out">
        <FavoriteButton id={trip.id} />
      </Animatable.View>
